...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    //[self.contactsViewController.locationManager startUpdatingLocation];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"RX" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"RX.sqlite"];
